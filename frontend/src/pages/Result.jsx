...
//   // Extract predictions passed as state via React Router navigation
//   const predictions = location.state?.predictions;

//   // Use dynamic career from predictions or fallback to default placeholders
//   const career = predictions?.suggestions?.[0] || {
//     title: "No career matched",
//     description: "Complete the quiz to receive personalized recommendations.",
//     matchConfidence: 0,
//     salaryRange: "N/A",
//     jobGrowth: "N/A",
//     skills: [],
...
//   // You can dynamically generate roadmap and resources based on your needs or AI output
//   const roadmap = [
//     {
//       level: "Foundation",
//       duration: "3-6 months",
...
//       {/* Career Info */}
//       <section className="bg-white shadow-md rounded-2xl p-6 relative transition-transform transform hover:-translate-y-1 hover:shadow-lg">
//         <div className="absolute top-6 right-6">
//           <button
//             onClick={() => setSaved(!saved)}
//             className={`flex items-center gap-2 px-3 py-1 rounded-lg border transition ${
...
//       {/* Learning Roadmap */}
//       <section className="bg-white shadow-md rounded-2xl p-6 transition-transform transform hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(124,58,237,0.25)] mt-6">
//         <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
//           <span className="text-purple-600">📘</span> Learning Roadmap
//         </h2>
//         <div className="space-y-4">
...
//         {/* Next Steps */}
//         <div className="bg-white shadow-md rounded-2xl p-6 transition-transform transform hover:-translate-y-1 hover:shadow-[0_6px_20px_rgba(124,58,237,0.25)] mt-6">
//           <h2 className="text-xl font-semibold mb-4">Next Steps</h2>
//           <div className="flex flex-col gap-3">
//             <button className="w-full border rounded-lg py-2 transition transform hover:-translate-y-1 hover:bg-green-500 hover:text-white">
//               Retake Quiz
