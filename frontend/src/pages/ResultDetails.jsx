      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <aside className="space-y-6">
          <div className="bg-white shadow-md rounded-2xl p-6">
            ...
            <div className="flex flex-col gap-3">
              <button className="border rounded-lg py-2 hover:bg-purple-500 hover:text-white">
                Retake Quiz
              </button>
              <button className="border rounded-lg py-2 hover:bg-purple-500 hover:text-white">
                View Saved Careers
              </button>
              <button className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-2 rounded-lg">
                <Download className="w-4 h-4" />
                Download PDF Report
              </button>
            </div>
